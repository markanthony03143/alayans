    ...
    <div class="container-fluid container">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                ...
                <li class="nav-item">
                    <a class="nav-link text-danger" href="/alayans/user/calendarbook.php">CALENDAR</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-danger" href="/alayans/user/notifications.php">NOTIFICATIONS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-danger" href="/alayans/user/settings.php">SETTINGS & PREFERENCES</a>
                </li>
